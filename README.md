...
| **Multi-agent systems with LangSmith observability** | [AI Agents for Automation/Hands-on Multi-Agent Systems/rental_law_queries_resolution (4).ipynb](<https://colab.research.google.com/github/alienrivero/great-learning-aiml/blob/main/AI%20Agents%20for%20Automation/Hands-on%20Multi-Agent%20Systems/rental_law_queries_resolution%20%284%29.ipynb>), [AI Agents for Automation/Case Study - AI Helpdesk Copilot/AI_Helpdesk_Copilot_MAS.ipynb](<https://colab.research.google.com/github/alienrivero/great-learning-aiml/blob/main/AI%20Agents%20for%20Automation/Case%20Study%20-%20AI%20Helpdesk%20Copilot/AI_Helpdesk_Copilot_MAS.ipynb>) |
...
| **Nested multi-agent (agent-as-tool) + FAISS vector search + Pydantic grounding checks** | [AI Agents for Automation/Case Study - AI Helpdesk Copilot/AI_Helpdesk_Copilot_MAS.ipynb](<https://colab.research.google.com/github/alienrivero/great-learning-aiml/blob/main/AI%20Agents%20for%20Automation/Case%20Study%20-%20AI%20Helpdesk%20Copilot/AI_Helpdesk_Copilot_MAS.ipynb>) |
...
| [`Case Study - AI Helpdesk Copilot/AI_Helpdesk_Copilot_MAS.ipynb`](<https://colab.research.google.com/github/alienrivero/great-learning-aiml/blob/main/AI%20Agents%20for%20Automation/Case%20Study%20-%20AI%20Helpdesk%20Copilot/AI_Helpdesk_Copilot_MAS.ipynb>) | Nested multi-agent LangGraph system for B2B SaaS support-ticket triage: an Orchestrator (intake/triage/escalation/delivery tools) calls a RAG Sub-Agent (FAISS retrieval over historical tickets, with a sufficiency check) as a nested tool, then a Response Agent drafts a reply and runs a Pydantic-based grounding check (claim-by-claim evidence verification) before delivery; exercised on 5 test cases with LangSmith tracing | `ticket_data.csv` (~500 historical tickets); needs a `config.json` with `OPENAI_API_KEY` (and optionally LangSmith tracing keys) |
...
| Customer support tickets (AI Helpdesk Copilot knowledge base) | `AI Agents for Automation/Case Study - AI Helpdesk Copilot/ticket_data.csv` |
